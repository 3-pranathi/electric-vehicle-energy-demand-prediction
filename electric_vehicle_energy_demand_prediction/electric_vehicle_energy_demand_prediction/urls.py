"""electric_vehicle_energy_demand_prediction URL Configuration
...
from electric_vehicle_energy_demand_prediction  import settings
...
urlpatterns = [
    ...
    url(r'^predict_energy_demand_prediction_type/$', remoteuser.predict_energy_demand_prediction_type, name="predict_energy_demand_prediction_type"),
    ...
    url(r'^Find_View_Prediction_Energy_Demand_Prediction_Type_Ratio/$', serviceprovider.Find_View_Prediction_Energy_Demand_Prediction_Type_Ratio, name="Find_View_Prediction_Energy_Demand_Prediction_Type_Ratio"),
    url(r'^Train_Test_DataSets/$', serviceprovider.Train_Test_DataSets, name="Train_Test_DataSets"),
    url(r'^View_Prediction_Energy_Demand_Prediction_Type/$', serviceprovider.View_Prediction_Energy_Demand_Prediction_Type, name="View_Prediction_Energy_Demand_Prediction_Type"),
